...
class CCIHosting(SolusvmHoster):
    ...
    def register(self, user_settings, vps_option):
        ...
        coinbase_url = self.browser.get_current_page().find('form')['action']
    ...
    def server_form(self, user_settings):
        ...
        :return: 
        """
        self.browser.post('https://www.ccihosting.com/accounts/cart.php', {
            'ajax': '1',
            'a': 'confproduct',
            'configure': 'true',
            'i': '0',
    ...
    def start(self):
        self.browser.open('https://www.ccihosting.com/offshore-vps.html')
